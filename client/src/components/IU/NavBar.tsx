...
export default function NavBar(): JSX.Element {
  ...
  const handleScroll = (): void => {
    // Определите условия, при которых нужно скрыть навигационный бар
  ...
  useEffect(() => {
    // Добавьте обработчик события прокрутки страницы
  ...
  return (
    <Disclosure as="nav" className={`bg-gray-800 navbar ${isNavbarHidden ? 'navbar-hidden' : ''} `}>
      {({ open }) => (
        <>
